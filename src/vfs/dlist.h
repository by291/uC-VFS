#ifndef UC_VFS_DLIST_H
#define UC_VFS_DLIST_H
...
static inline bool sys_dlist_is_head(const sys_dlist_t *list,
...
static inline bool sys_dlist_is_tail(const sys_dlist_t *list,
                                     const sys_dnode_t *node) {
...
static inline sys_dnode_t *
sys_dlist_peek_head_not_empty(const sys_dlist_t *list) {
  return list->head;
}
...
static inline sys_dnode_t *
sys_dlist_peek_next_no_check(const sys_dlist_t *list, const sys_dnode_t *node) {
...
static inline sys_dnode_t *
sys_dlist_peek_prev_no_check(const sys_dlist_t *list, const sys_dnode_t *node) {
...
static inline void
sys_dlist_insert_at(sys_dlist_t *list, sys_dnode_t *node,
...
static inline size_t sys_dlist_len(const sys_dlist_t *list) {
  ...
  SYS_DLIST_FOR_EACH_NODE(list, node) { len++; }
  return len;
}
